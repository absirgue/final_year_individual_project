...
class TestKMeansIterator(unittest.TestCase):

    def test_get_optimal_gives_expected_result(self):
        iterator = KMeansIterator(np.array([]),2)
